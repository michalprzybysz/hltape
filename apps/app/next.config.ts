...
// Sentry is entirely optional: without SENTRY_ORG, SENTRY_PROJECT and SENTRY_AUTH_TOKEN
// the source-map upload plugin has nothing to talk to, so it is not applied at all and a
// fresh clone builds with zero Sentry environment variables set.
...
export default sentryOrg && sentryProject && sentryAuthToken
  ? withSentryConfig(config, {
      ...
      webpack: {
        ...
        // handlers.) See the following for more information:
